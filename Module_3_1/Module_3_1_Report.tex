...
Based on the finalized layout plan and campus map, the festival's primary ``Region of Interest'' (ROI) covers a consolidated area of approximately \textbf{82 acres} (33.2 hectares), representing about 26\% of the total 320-acre IIT Delhi campus. This region is defined by a continuous block encompassing the West Zone (Nalanda/SAC) and the East Zone (Sports/Academic/Rose Garden), connected by a narrow corridor.

For the purpose of spatial modeling in Module 3.2, this ROI is divided into a fine grid of \textbf{137 cells}, each approximately \textbf{0.6 acres} ($50\text{m} \times 50\text{m}$) in size. The breakdown of sub-zones is detailed in Table \ref{tab:roi_refined}.
...
West & Nalanda, SAC, OAT Block & 25 & Event Venue \\
East & Sports, Academic, Rose Garden Block & 52 & Main Festival Zone \\
Circulation & Internal Corridors & 5 & Circulation \\
\midrule
  & \textbf{Total ROI} & \textbf{82} & --- \\
\bottomrule
\end{tabular}
\end{table}
