...
class PDFReport(FPDF):
    ...
    def header(self):
        ...
        self.cell(0, 10, 'CLL782: Process Optimization Module 3.4: Water Refill Station Planning', align='R')
        self.ln(15)
...
try:
    with open('Module_3_4_Report.md', 'r') as f:
        md_content = f.read()

    pdf = PDFReport()
    pdf.add_page()
    pdf.add_markdown_content(md_content)
    pdf.output('Module_3_4_Report.pdf')
    print("PDF Generated successfully: Module_3_4_Report.pdf")
