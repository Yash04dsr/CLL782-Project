...
Bins & 404 & 535 & 404 \\
Stations & 40 & 40 & 40 \\
$C_{sys}$ (Rs. Lakhs) & 83.9 & 95.0 & 83.9 \\
$E_{sys}$ (kg CO\textsubscript{2}e) & 6,690 & 7,345 & 6,690 \\
$I_{sys}$ & 160,657 & 136,026 & 160,657 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
    ...
    \item \textbf{Budget allocation}: The Pareto analysis (Module 3.5) shows that the minimum-cost and minimum-environment solutions coincide --- investing in the right number of bins reduces both cost and CO\textsubscript{2}e simultaneously.
\end{enumerate}

The recommended operating point: \textbf{436 waste bins} (3 types, Rs.\,35L), \textbf{40 water stations} (Rs.\,40L), \textbf{6 segregated vehicles} (Rs.\,10L/day operational), for a total system cost of approximately \textbf{Rs.\,85 Lakhs capital + Rs.\,10 Lakhs/day operational}.
